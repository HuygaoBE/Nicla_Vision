...
class BLESimpleCentral:
    ...
    def _irq(self, event, data):
        if event == _IRQ_SCAN_RESULT:
            ...
            #kq_adv = binascii.hexlify(bytes(adv_data))#.decode('unicode_escape')
            #print("KQ ADV_DATA:------------------",type(kq_adv))
            #kqdata1 = "".join(chr(c) for c in kq_adv)
            #print("KQDATA1:-------------------------",kq_adv.decode('utf-8'))
            #print("KQ ADV_TYPE:--------------------",type(adv_type))
            if(addr_type == 0):
    ...
    def scan(self, callback=None):
        ...
        self._ble.gap_scan(50000, 30000, 30000)
